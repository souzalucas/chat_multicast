...
public class ChatGUI extends javax.swing.JFrame implements UIControl {
    ...
    private void initComponents() {
        ...
        lblCrypto = new javax.swing.JLabel();
        ...
        checkboxCrypto = new javax.swing.JCheckBox();
        ...
        pnlOpcoes.setMinimumSize(new java.awt.Dimension(124, 89));
        pnlOpcoes.setPreferredSize(new java.awt.Dimension(210, 89));
        ...
        lblCrypto.setText("Criptografia: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        pnlOpcoes.add(lblCrypto, gridBagConstraints);
        ...
        checkboxCrypto.setMinimumSize(new java.awt.Dimension(114, 19));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        pnlOpcoes.add(checkboxCrypto, gridBagConstraints);
        checkboxCrypto.setSelected(false);
    ...
    private void btnConectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConectarActionPerformed
        try {
            ...
            checkboxCrypto.setEnabled(false);
            ...
            listener.run();
            /* Enviar JOIN para o grupo */
            protoController.send("Todos", "JOIN");
    ...
    private void btnDesconectarActionPerformed(java.awt.event.ActionEvent evt) {try {
        ...
        if (protoController != null) {
            protoController.send("Todos", "LEAVE");
        ...
        checkboxCrypto.setEnabled(true);
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if ((msg.trim().length() > 0) && (lstLista.getSelectedIndex() != -1)) {
            ...
            /** Enviar para o grupo ou individuo */
            try {
                protoController.send(nickTarget, msg);
            } catch (IOException ioe) {
                System.err.println("Erro ao chamar funcao de envio" + ioe);
            } 
    ...
    /**
     * Retorna se a checkboxCrypto está ou não marcada
     * @return true ou false
     */
    public boolean messageEncrypted() {
        return checkboxCrypto.isSelected();
    }
    ...
    public void update(Message m) {
        switch (m.getType()) {
            case 1:
                if (this.getApelido().equals(m.getSource()) == false) {
    ...
    private javax.swing.JLabel lblCrypto;
    ...
    private javax.swing.JCheckBox checkboxCrypto;
